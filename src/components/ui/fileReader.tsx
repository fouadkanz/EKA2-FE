...
function FileReader() {
  return (
    <div className="w-[300px] flex items-start justify-between my-2.5 bg-gray-50 dark:bg-gray-600 rounded-xl p-2">
            <div>
            ...
            <div className="inline-flex self-center items-end">
