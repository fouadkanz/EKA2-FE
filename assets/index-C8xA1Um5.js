...
var Trigger$2 = CollapsibleTrigger$1;
...
const MessageMenu = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-normal text-gray-500 dark:text-gray-400 flex justify-between", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row space-x-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Volume2, { className: "pt-[1.5px] size-5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ThumbsDown, { className: "pt-1 size-5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ThumbsUp, { className: "pt-1 size-5" })
    ] })
  ] });
};
...
const MessageBubble = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-1 space-x-1", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col w-full p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl mb-3", children: [
      ...
      index !== 0 && message.sender !== "user" && /* @__PURE__ */ jsxRuntimeExports.jsx(MessageMenu, {})
    ] })
  ] });
};
  ...
  const renderWords = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { ref: scope, className: "inline text-3xl md:text-5xl", children: wordsArray.map((word, idx) => {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-block", children: [
        word.text.map((char, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.span,
          {
            initial: {},
            className: cn(
...
const MessageList = ({ messages, setLoading, isLoading }) => {
...
function EventHandler() {
  ...
  function off(evt, cb2) {
    listeners2[evt] = getListeners(evt).filter((e) => e !== cb2);
    return self;
  }
  function clear() {
    listeners2 = {};
...
const ChatMessageInput = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:p-3", children: !isLaoding ? /* @__PURE__ */ jsxRuntimeExports.jsx(
    ChatInput,
    {
      value: text,
  ...
  ) : /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingBar, { isLaoding }) });
};
const ChatWindow = ({
  activeSession,
  setLoading,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      MessageList,
      {
        messages: activeSession == null ? void 0 : activeSession.messages,
        setLoading,
        isLoading
      }
    ),
...
const ChatSideMenu = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: config2.components.sideMenu.length > 1 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "chats", className: "h-[97svh] w-full overflow-auto", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "chats", className: "flex flex-col gap-2 w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      SessionList,
      {
        sessions,
        onSelectSession,
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:flex md:flex-grow", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex flex-col flex-grow p-2 text-center h-screen w-screen", children: [
      ...
      config.components.chatWindow && /* @__PURE__ */ jsxRuntimeExports.jsx(
        ChatWindow,
        {
          activeSession,
          setLoading,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "h-[100vh] md:flex-shrink-0 w-1/4 md:p-3 md:text-center hidden md:block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ChatSideMenu,
      {
        config,
        sessions,
